...
<head>
    ...
    <title>CRUD de Producto con PHP PDO y POO</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<div class="container mt-5">

    <h1 class="text-center mb-4">CRUD de Producto con PHP, PDO y POO</h1>
                ...
                <tbody>
                    <?php if (count($producto) > 0): ?>
                        <?php foreach ($producto as $productos): ?>
                            <tr>
                                <td><?php echo htmlspecialchars($productos['id']); ?></td>
                                <td><?php echo htmlspecialchars($productos['nombre']); ?></td>
                                <td><?php echo htmlspecialchars($productos['descripcion']); ?></td>
                                <td><?php echo htmlspecialchars($productos['existencia']); ?></td>
                                <td>$<?php echo number_format($productos['precio'], 2); ?></td>
                                <td>
                                    <a href="index.php?editar=<?php echo $productos['id']; ?>" class="btn btn-warning btn-sm">
                                        Editar
                                    </a>
                                    <a href="index.php?eliminar=<?php echo $productos['id']; ?>"
